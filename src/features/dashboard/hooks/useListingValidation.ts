...
export type FormStepState =
  | { step: 1; data: Partial<Pick<ListingSchema, 'title' | 'description' | 'pricePerNight' | 'city' | 'maxGuests' | 'bedrooms' | 'beds' | 'baths' | 'buildingFloors' | 'propertyFloor' | 'constructionYear' | 'minNights' | 'propertyType' | 'accommodationType' | 'maxNights' | 'isPetFriendly'>> }
