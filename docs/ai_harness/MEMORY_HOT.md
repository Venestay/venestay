...
| ENCODING-MYTRIPS-001   | Tildes corruptas en browser                | `Out-File -Encoding UTF8` en PowerShell | ✅ Resuelto              |
...
| **SPEC-BOOKINGS-MYTRIPS-REGRESSION**            | src/features/bookings/components/MyTrips.tsx         | **COMPLETADO**           | 2/3            |
| **Infraestructura QA Branch**                   | origin/qa (Venestay/venestay)                        | **RECUPERADO**           | 1/3            |
| **Limpieza de 18 ramas antiguas**               | origin/\*                                            | **COMPLETADO**           | 1/3            |
...
1. **[P0 — QA MANUAL]** Leer el artefacto `qa_manual_testing_plan.md` enlazado arriba y coordinar con el usuario la validación visual y funcional en el browser (`npm run dev`). *NOTA: Única tarea bloqueante para fusionar a main.*
2. **[COMPLETADO]** Eliminación de las ramas antiguas de la org.
3. **[COMPLETADO]** Implementar checklist de merge como proceso obligatorio del equipo (SPEC-PROCESS-MERGE-01).
