...
2. **Trust Score radial animado:** SVG circular con `strokeDasharray` calculated sobre el score. Color adaptativo: rojo si score < 40, dorado (`#C5A059`) si score 40–79, verde esmeralda si score ≥ 80. La animación del trazo se ejecuta al montar el componente con duración 600ms.
